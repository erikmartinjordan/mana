var data = {
    ...
    'tuk-tuk': {
        ...
        'date': [15, 'Marzo', 2016],
        'description': 'Antes de subirte a un tuk-tuk de Bangkok, deberías tener cuidado cuando te prometen viajes a 40 bahts. Ojo, es una trampa.',
    },   
    'perdido': {
        'title': 'Perdido en Bangkok',
        'date': [13, 'Marzo', 2016],
        'description': 'Desorientado, desubicado, perdido... Así me he sentido en la primera vez que visito el Reino de Siam. Ah, por cierto, Bangkok huele a «caldofrán».',
    },
    'cuenta-atras': {
        'title': 'Los días previos a marcharse lejos',
        'date': [7, 'Marzo', 2016],
        'description': 'Comienza la cuenta atrás. No queda nada para abandonar España. He aquí algunas de las cosillas que me pasan por la cabeza antes de partir.',
    },
    'nuevas-rutinas': {
        'title': 'Nuevas rutinas',
        'date': [2, 'Marzo', 2016],
        'description': 'El día que me desenganché del gimnasio después de llevar diez años entrenando allí. Ya estoy dado de baja. Ha sido como dejar de cepillarme los dientes.',
    },
    'ansiedad-del-viajero': {
        'title': 'Ansiedad del viajero',
        'date': [29, 'Febrero', 2016],
        'description': 'Hoy es el último día de este extraño mes de febrero. He vuelto a dormir mal, y es que empiezo a estar realmente nervioso por el viaje.',
    },
    'petar': {
        'title': 'A muchos kilómetros',
        'date': [26, 'Febrero', 2016],
        'description': 'De cómo conocí a Petar y cómo nos hicimos amigos en Alemania, estando de Erasmus. A veces, las mejores cosas se encuentran a muchos kilómetros de casa.',
    },
    'digital': {
        'title': 'Nosotros solamente pasábamos por ahí',
        'date': [22, 'Febrero', 2016],
        'description': 'Era digital: mis nietos preguntándome qué cojones era un bolígrafo y qué enfermedad teníamos para cortar árboles que nos permitiesen escribir en papel.',
    },
    'remando-a-favor': {
        'title': 'Remando a favor',
        'date': [18, 'Febrero', 2016],
        'description': 'La publicidad nos engaña, persuade, seduce y manipula para que compremos mierda que no necesitamos.',
    },
    'aceptar-condiciones-privacidad': {
        'title': 'Acepta las condiciones de privacidad',
        'date': [10, 'Febrero', 2016],
        'description': 'Nos la pela. Aceptamos que nos espíen al navegar por internet. Que aparezcan anuncios según el historial de búsqueda. Acepta las condiciones de privacidad.',
    },
    'westie': {
        'title': 'Tiqui y su correa',
        'date': [9, 'Febrero', 2016],
        'description': 'Tiqui es un animal peludo que sin pronunciar ni una sola palabra, me enseña lecciones de la vida. Únicamente hace falta obervarla y surge la magia...',
    },
    'ya-pensamos-por-ti': {
        'title': 'Ya pensamos por ti',
        'date': [6, 'Febrero', 2016],
        'description': 'Cuando era un mocoso me explicaron cuál era el camino que tenía que seguir en la ruta hacia el éxito. Sí, les gustaba pensar por mí.',
    },
    'esclavo-moderno': {
        'title': 'El esclavo moderno tiene unas Ray-Ban',
        'date': [4, 'Febrero', 2016],
        'description': 'Un esclavo moderno tiene un coche blanco metalizado, chapa brillante y pulida, reluciente, diseñada por nuestros amigos germanos. Y lleva unas Ray-Ban.',
    },
    'carlos': {
        'title': 'Carlos',
        'date': [1, 'Enero', 2016],
        'description': 'Ayer, después de mucho tiempo, recibí la llamada de Carlos. Me dijo cosas que no me gustó demasiado escuchar.',
    },
    'poquet-a-poquet': {
        'title': 'Poquet a poquet',
        'date': [30, 'Diciembre', 2015],
        'description': 'Poquet a poquet es una expresión catalana que significa poco a poco, a fuego lento. Como la cocción de esta web. Y es que aún le queda tiempo al plato.',
    },
    'a-que-lugar-viajar': {
        'title': 'Lugar de destino',
        'date': [16, 'Diciembre', 2015],
        'description': '¿Por qué escoger Tailandia como lugar destino? Vivir una temporada en el país de la sonrisa según tres objetivos que me gustaría cumplir.',
    },
    'ahora': {
        'title': 'Ahora',
        'date': [11, 'Diciembre', 2015],
        'description': 'Es un momento para irse lejos. Aprender. Absorber. Desprenderse de la rutina del día a día. Siento que ahora es el momento de irse lejos.',
    },
    'inicio': {
        'title': 'Se abre el telón',
        'date': [9, 'Diciembre', 2015],
        'description': 'Por qué un blog y no una tortilla de patata. Por si alguien leyese alguna de las líneas y se sintiese identificado. Nada me haría más feliz.',
    }
}
