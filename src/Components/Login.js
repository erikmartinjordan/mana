    ...
    return (
        <div className = 'Login'>
            <div className = 'Login-wrap'>
                <h2>¡Oh, genial!</h2>
                <p>Estás a punto de acceder, ahora debes iniciar sesión con una cuenta de Gmail para continuar. Podrás: </p>
                <ul>
                ...
                <div className = 'info'>El acceso vía Google previene cuentas falsas y <em>spam</em>. Nomoresheet no publicará en tu nombre, ni te enviará <em>mails</em>, ni utilizará tus datos.</div>
            </div>
