        ...
        <li key = {line.key}>
            ...
            <Linkify properties={{target: '_blank', rel: 'nofollow noopener noreferrer'}}>
                ...
                <div className = 'Meta-Post'>
                    ...
                    {line.userUid === user.uid && <EditPost postId = {props.match.params.string} replyId = {line.key}/>}
                    {line.userUid === user.uid && <DeletePost type = 'reply' post = {props.match.params.string} id = {line.key} />}
                </div>
            </Linkify>
        </li> );
