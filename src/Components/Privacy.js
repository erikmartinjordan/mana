...
const Privacy = () => {
    ...
    return (
        <div className = 'Privacy'>
            ...
            <h2>Anuncios</h2>
            <p>Actualmente, hay un anuncio que aparece en la barra lateral izquierda de la web. El anuncio se muestra para usuarios que no hayan iniciado sesión. En el resto de la web no hay ningún anuncio, tampoco artículos patrocinados. Si detectas algún enlace sospechoso de contenter publicidad, por favor, ponte en contacto vía <a href = 'https://twitter.com/@ErikMarJor' target = '_blank' rel = 'nofollow noopener noreferrer'>Twitter</a>.</p>
