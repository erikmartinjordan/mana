...
const Privacy = () => {
    ...
    return (
        <div className = 'Privacy'>
            ...
            <h2>Anuncios</h2>
            <p>Actualmente, no hay ningún anuncio en la web. Si detectas algún enlace sospechoso de contenter publicidad, por favor, ponte en contacto vía <a href = 'https://twitter.com/@ErikMarJor' target = '_blank' rel = 'nofollow noopener noreferrer'>Twitter</a>.</p>
