...
const Privacy = () => {
    ...
    return (
        <div className = 'Privacy'>
            ...
            <h2>Anuncios</h2>
            <p>Actualmente, no se muestra ningún anuncio en la web. Si detectas algún enlace sospechoso de contenter publicidad, por favor, ponte en contacto vía <a href = 'mailto:hola@erikmartinjordan.com'>hola@erikmartinjordan.com</a>.</p>
